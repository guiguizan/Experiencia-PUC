<html>
    <head>
      ...
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
        ...
        <link rel="stylesheet" type="text/css" href="../../css/cartao.css">
        <script src="../../javascript/jquery.card.js"></script>
...
<div class='checkout'>
  <div class='order' style="text-align:center">
    ...
    <img class="logoMoovies" src='../../imagens/logoProjetoPNG.png'>

    <h5>Mensalidade</h5><h4>R$ 10,50</h4>
    
    <br>
    <h5>Sua conta atual</h5><h4> Premium </h4>
    <h5 class='total'>Total</h5><h1>R$ 10,50</h1>
  </div>
  <h2>Dados do cartão</h2>
  <form method="POST" action="../../php/alterarDadosCartao.php">
  <div id='payment' class='payment'>
    ...
    <p class='field'>
        ...
        <input type='text' id='nomeDoTitular' name='nomeDoTitular' placeholder='nome do titular' title='Nome do titular' value="<?php echo $_SESSION["nomeDoTitular"]?>" />
      </p>
        <p class='field'>
        <svg id='i-cardfront' xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 28 28;" xml:space="preserve" width="28px" height="28px"><g>
          <path d="M471.5,88h-432C17.72,88,0,105.72,0,127.5v256C0,405.28,17.72,423,39.5,423h432c21.78,0,39.5-17.72,39.5-39.5v-256   C511,105.72,493.28,88,471.5,88z M496,383.5c0,13.509-10.991,24.5-24.5,24.5h-432C25.991,408,15,397.009,15,383.5v-256   c0-13.509,10.991-24.5,24.5-24.5h432c13.509,0,24.5,10.991,24.5,24.5V383.5z" fill="#dddfe6"/>
        ...
        <input type='text' id='cardnumber' name='numeroDoCartao' placeholder='1234 5678 9123 4567' pattern='\d*' title='Card Number' value="<?php echo $_SESSION["numeroDoCartao"]?>" />
      </p>
        <p class='field space'>
          ...
          <input type='text' id='cardexpiration' name='validadeDoCartao' placeholder="MM / YYYY" title='Card Expiration Date' value="<?php echo $_SESSION["validadeDoCartao"] ?>"/>
      </p>
        <p class='field'>
          ...
          <input type='text' id='cardcvc' name='codigoDoCartao' placeholder="123" pattern="\d*" title='CVC Code' value="<?php echo  $_SESSION["codigoDoCartao"] ?>"/>
      </p>
      <button class='button-cta' title='Alterar dados'><span>Alterar</span></button>
    </div>
